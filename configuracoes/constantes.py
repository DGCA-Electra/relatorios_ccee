...
ANOS = [str(y) for y in range(datetime.now().year - 1, datetime.now().year + 5)]

PATH_CONFIGS = {
    "sharepoint_root": "ELECTRA COMERCIALIZADORA DE ENERGIA S.A/GE - DGCA/DGA/CCEE/Relatórios CCEE",
    "contatos_email": "ELECTRA COMERCIALIZADORA DE ENERGIA S.A/GE - DGCA/DGC/Macro/Contatos de E-mail para Macros.xlsx",
    "user_base": "C:/Users"
}
